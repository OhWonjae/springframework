...
<html>
    ...
    <%-- 헤더 부분 --%>
	  ...
	  <a class="navbar-brand" href="./">
	    <img src="<%=application.getContextPath()%>/resources/images/logo.png" width="30" height="30" class="d-inline-block align-top">
	    Spring
	  </a>
	  <div>
	    <div>
	    	<%-- 세션을 이용한 로그인 인증에 따른 ui 선택 --%>
	    	...
	    	<%-- 스프링 security 이용한 로그인 인증에 따른 ui 선택 --%>
